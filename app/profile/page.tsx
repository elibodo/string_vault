        ...
        <table className="min-w-full border-collapse border text-sm">
          <thead className="bg-gray-500 ">
            <tr className="whitespace-nowrap">
              ...
              <th className="border px-4 py-2 text-left">Sub Model</th>
              <th className="border px-4 py-2 text-left">Year</th>
              <th className="border px-4 py-2 text-left">Made In</th>
          ...
          <tbody>
            {guitars.map((guitar) => (
              ...
              >
                <td className="border px-4 py-2">{guitar.brand}</td>
                <td className="border px-4 py-2">{guitar.model}</td>
                <td className="border px-4 py-2">{guitar.subModel}</td>
                <td className="border px-4 py-2">{guitar.year}</td>
                <td className="border px-4 py-2">{guitar.madeIn}</td>
                <td className="border px-4 py-2">${guitar.cost}</td>
                <td className="border px-4 py-2">${guitar.value}</td>
                <td className="border px-4 py-2">{guitar.serialNumber}</td>
                <td className="border px-4 py-2 text-center whitespace-nowrap">
                  <button className="hover:underline mr-4">Edit</button>
